...
export function About() {
  return (
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="min-h-screen flex items-center justify-center py-24 px-32" style={{ position: 'relative', zIndex: 10 }}>
        <motion.div
        ...
        >
          ...
          <div className="mb-16">
            <div className="text-center mb-4">
              <h1 className="text-7xl text-[var(--galaxy-blue)] font-bold heading">AT</h1>
              <h1 className="text-7xl text-[var(--galaxy-blue)] font-bold heading">NEXORIX TECHLAB</h1>
            </div>
            <p className="text-2xl text-black font-bold text-center mt-6 max-w-3xl mx-auto">
              we don’t adapt to the future — we engineer it with AI at the core.
            </p>
            <div className="text-center">
              <p className="text-2xl text-black mt-2 max-w-3xl mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
